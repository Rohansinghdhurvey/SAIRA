...
def wishme():
    ...
    if 0 <= hour <= 12:
        var.set("Hello ! Good Morning Rohan")
        window.update()
        speak("Hello ! Good Morning Rohan!")
    elif 12 <= hour <= 18:
        var.set("Hello ! Good Afternoon Rohan!")
        window.update()
        speak("Hello ! Good Afternoon Rohan!")
    else:
        var.set("Hello ! Good Evening Rohan")
        window.update()
...
#general conversation
            ...
            var.set("My Creator is Rohan Singh")
            window.update()
            speak("My Creator is Rohan Singh")

        elif 'sleep' in query:
            var.set('Sleeping...............')
            window.update()
            speak("OK Rohan!! time to sleep have a good day")
            quit()
...
#open system folders and softwares
            ...
            os.startfile("C:\\Users\\rohan\\AppData\\Roaming\\Microsoft\\Windows\\Start Menu\\Programs\\Visual Studio Code\\Code.exe")
            ...
            webbrowser.open('https://github.com/Rohansinghdhurvey')
        ...
        elif 'open studies' in query:
            var.set('Opening studie folder')
            window.update()
            speak('opening studie folder')
            os.startfile("E:\\Studies")
...
#random module 
        ...
        elif ('play music' in query) or ('music' in query) or('songs' in query):
